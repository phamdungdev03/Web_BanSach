...
if (empty($_POST['ten']) || empty($_POST['sdt']) || empty($_POST['city']) || empty($_POST['district']) || empty($_POST['ward']) || empty($_POST['diachicuthe']) || empty($_POST['email']) || empty($_POST['tendangnhap']) || empty($_POST['matkhau'])) {
