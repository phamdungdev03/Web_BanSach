		...
		<div>
			<?php
			  $conn = mysqli_connect("localhost","root","","hung_mobile");
				...
				$sql = "SELECT sp.product_id, sp.product_name, sp.product_description, sp.product_image, sp.price, sp.stock_quantity, sp.category_id, dm.`category_description`
                FROM san_pham sp
  ...
  ?>
   ...
   <a href="./dtvivo.php">
    <img  class="sc" name ="img5" src="./hinh_anh/danhmucsanpham/vivo-logo-220-220x48-3.png"  alt="">
            ...
            <p>__________ĐIỆN THOẠI IPHONE__________</p>
        </div>
