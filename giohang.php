  ...
  <table align ="center">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><a href="giohang.php?action=delete&id=<?=$row["product_id"]?>" style=" text-decoration: none;"><div class="remove">Xóa</div></a></td>
      </tr>
      <?php
      ...
      <tr>
        ...
        <td></td>
        <td></td>
        <td><p>Tổng tiền: <span  class = "gia"><?=$parsed_gia=number_format($total, 0, ",", ",");?>₫</span></p></td>
        <td></td>
